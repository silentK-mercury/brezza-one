Understood. Thank you for the clarification. It seems the best format for you is the raw Markdown source provided in a single code block, with the script code itself kept separate.

Here is the updated README in the format you requested.
